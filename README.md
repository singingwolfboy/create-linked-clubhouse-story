...
automatically create a story on [Shortcut](https://shortcut.io/) when
...
[Shortcut already has an integration with GitHub.](https://help.shortcut.io/hc/en-us/articles/207540323-Using-The-Shortcut-GitHub-Integration)
...
templating system. It receives [the Story object returned from the Shortcut API](https://shortcut.io/api/rest/v3/#Story). Note that you may want to use the
...
Shortcut supports the concept of [iterations](https://help.shortcut.io/hc/en-us/articles/360028953452-Iterations-Overview)
...
- We assume that each team has an associated [Shortcut group](https://help.shortcut.io/hc/en-us/articles/360039328751-Groups-Group-Management),
